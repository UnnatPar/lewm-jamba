"""Locate the crossover: 1,960 is the best sub-2,048 window, so test the next chunk-efficient one.
...
def main():
    ...
    print("CROSSFIND_JSON " + json.dumps(out), flush=True)
